...
public class lightbox_memberSignup_orangeMobileBroadband_cookiesBlocked_dpp {
...
////////////////////////$/Applications/Firefox.app/Contents/MacOS/firefox-bin -p///////////////////////////////////////////////
		...
		driver.findElement(By.xpath("//a[contains(text(),'Orange mobile broadband')]")).click();
		...
		//broadband signup page
		
		driver.get("http://secureweb.c1.dev.portaldev2.local/id/donglesignup.php");
