...
public class Android_Apps_Tv_Music_Image3 {
    public static void main(String[] args) throws Exception {
    	...
    	Thread.sleep(3000);
    		...
    		//Image 3
    	WebElement Image3Element = driver.findElementByXPath(Constants.m4Image3);
    	Image3Element.isDisplayed();
    	Image3Element.click();
		...
		String testName = "Android_ScreenShotSave";
		 try
	        {
	        //String Test = "/Users/chrismorris/Documents/MHP_screenshit/Image3.png";
