...
public class Android_Apps_Tv_Music_Link1 {
    public static void main(String[] args) throws Exception {
    	...
    	WebElement MenuTab = driver.findElementByXPath(Constants.AppsTvMusicTab);
    	MenuTab.isDisplayed();
    	MenuTab.click();
    	Thread.sleep(3000);
    		...
    		//Apps Tv Music Link1
    	WebElement Link1Element = driver.findElementByXPath(Constants.m4Link1);
    	Link1Element.isDisplayed();
    	Link1Element.click();
